...
function twentyten_posted_on() {
	printf( __( '<span class="%1$s">Posted on</span> %2$s %4$s<span class="meta-sep">by</span> %3$s', 'twentyten' ),
		...
		sprintf( '<span class="author vcard" itemprop="creator"><a class="url fn n" href="%1$s" title="%2$s">%3$s</a></span>',
			get_author_posts_url( get_the_author_meta( 'ID' ) ),
			sprintf( esc_attr__( 'View all posts by %s', 'twentyten' ), get_the_author() ),
			get_the_author()
		),
		sprintf('<meta itemprop="datePublished" content="%1$s" />',
			get_the_time('Y-m-d\TH:i', get_the_ID())
		)
	);
}
endif;
